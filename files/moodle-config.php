...
$CFG->dbtype    = getenv('MOODLE_DATABASE_TYPE');      // 'pgsql', 'mariadb', 'mysqli', 'mssql', 'sqlsrv' or 'oci'
...
$CFG->dboptions = array(
    ...
    'dbport'    => getenv('MOODLE_DATABASE_PORT'),          // the TCP port number to use when connecting
